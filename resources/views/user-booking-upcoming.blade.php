<?php $page = 'user-booking-upcoming'; ?>
                            ...
                            <div class="col-xl-7 col-lg-8 col-sm-12 col-12">
                                <div class="booking-lists">
                                    <ul class="nav">
                                        ...
                                        <li><a class="active" href="{{ url('user-booking-upcoming') }}">Upcoming</a></li>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#inprogress_booking">#1007</a></td>
                                            <td>
                                                <div class="table-avatar">
                                                    <a href="#" class="avatar avatar-lg flex-shrink-0">
                                                        <img class="avatar-img"
