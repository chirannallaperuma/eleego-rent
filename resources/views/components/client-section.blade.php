                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="choose-img choose-black">
                                <img src="{{ URL::asset('/build/img/icons/bx-selection.svg') }}" alt="">
                            </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="choose-img choose-secondary">
                                <img src="{{ URL::asset('/build/img/icons/bx-crown.svg') }}" alt="">
                            </div>
                            <div class="choose-content">
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="choose-img choose-primary">
                                <img src="{{ URL::asset('/build/img/icons/bx-user-check.svg') }}" alt="">
                            </div>
                            <div class="choose-content">
                        ...
                        <div class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="{{ URL::asset('/build/img/profiles/avatar-02.jpg') }}" class="img-fluid"
                                        alt="img">
                                </div>
                            </div>
                ...
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <div class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="{{ URL::asset('/build/img/profiles/avatar-03.jpg') }}" class="img-fluid"
                                        alt="img">
                                </div>
                            </div>
                            <div class="review-details">
                ...
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <div class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="{{ URL::asset('/build/img/profiles/avatar-04.jpg') }}" class="img-fluid"
                                        alt="img">
                                </div>
                            </div>
                            <div class="review-details">
    ...
    <section class="pricing-section pricing-page pricing-section-bottom">
        <div class="container">
                ...
                <div class="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
                    <div class="price-card price-selected flex-fill">
                        ...
                        <div class="price-body">
                            <img class="img-fluid" src="{{ URL::asset('/build/img/price-plan.png') }}"
                                alt="Price Plan">
                        </div>
                    </div>
                </div>
            ...
            <div class="user-app-group">
                <div class="app-left">
                    <img src="{{ URL::asset('/build/img/bg/app-left.png') }}" class="img-fluid"
                        alt="App Available">
                </div>
                <div class="app-right">
                    <img src="{{ URL::asset('/build/img/bg/app-right.png') }}" class="img-fluid"
                        alt="App Available">
                </div>
                <div class="row">
                    <div class="col-lg-7">
                            ...
                            <div class="download-btn">
                                <div class="app-avilable" data-aos="fade-down">
                                    <a href="javascript:void(0)"><img
                                            src="{{ URL::asset('/build/img/play-store.svg') }}" alt="PlayStore"></a>
                                </div>
                                <div class="app-avilable" data-aos="fade-down">
                                    <a href="javascript:void(0)"><img src="{{ URL::asset('/build/img/apple.svg') }}"
                                            alt="AppStore"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 d-none d-lg-block">
                        <div class="car-holder">
                            <img class="app-car img-fluid" src="{{ URL::asset('/build/img/app-car.png') }}"
