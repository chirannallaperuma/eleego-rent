<?php $page = 'user-booking-inprogress'; ?>
                            ...
                            <div class="col-xl-7 col-lg-8 col-sm-12 col-12">
                                <div class="booking-lists">
                                    <ul class="nav">
                                        ...
                                        <li><a class="active" href="{{ url('user-booking-inprogress') }}">Inprogress</a>
                                        </li>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#inprogress_booking">#1002</a></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#inprogress_booking">#1004</a></td>
                                            <td>
                                                <div class="table-avatar">
                                                    <a href="#" class="avatar avatar-lg flex-shrink-0">
                                                        <img class="avatar-img"
