                ...
                <div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
                    <div class="booking-details payment-details">
                        ...
                        <div class="payment-method">
                            ...
                            <ul>
                                <li><a href="#"><img src="{{ URL::asset('/build/img/icons/payment-1.svg') }}"
                                            alt="Payment Icon"></a></li>
                                <li><a href="#"><img src="{{ URL::asset('/build/img/icons/payment-2.svg') }}"
                                            alt="Payment Icon"></a></li>
                                <li><a href="#"><img src="{{ URL::asset('/build/img/icons/payment-3.svg') }}"
                                            alt="Payment Icon"></a></li>
                                <li><a href="#"><img src="{{ URL::asset('/build/img/icons/payment-4.svg') }}"
                                            alt="Payment Icon"></a></li>
                            </ul>
                            <div class="booking-form">
                                <div class="booking-title">
